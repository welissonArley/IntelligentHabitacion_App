...
namespace Homuai.App.ViewModel.CleaningSchedule
{
    public class TaskDetailsViewModel : BaseViewModel
    {
        ...
        public TaskDetailsViewModel(Lazy<ICalendarUseCase> useCase, Lazy<IHistoryOfTheDayUseCase> historyOfTheDayUseCase)
        {
            ...
            {
                await FillTaskDayDetailsModel((DateTime)dateReturned, TaskModel.Room);
            });
            ...
            {
                await SeeDetailsTask((DetailsTaskCleanedOnDayModel)taskToRate);
            });
        }
        ...
        private async Task SeeDetailsTask(DetailsTaskCleanedOnDayModel taskToRateModel)
        {
